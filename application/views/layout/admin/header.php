        ...
        <div class="collapse navbar-collapse" id="navbar-mobile">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown dropdown-user">
                    ...
                    <!--                    <img src="-->
                    <? //= empty($user['avatar'])?base_url(GLOBAL_URL).'images/placeholders/placeholder.jpg':base_url().$user['avatar'];?><!--" class="rounded-circle" alt="">-->
                    <!--                    <span>-->
                    <? //=!empty($user['name'])?$user['name']:'Admin Dashboard';?><!--</span>-->
                    <!--                </a>-->
            ...
            <div class="sidebar-content">
                ...
                <div class="card card-sidebar-mobile">
                    ...
                    <ul class="nav nav-sidebar" data-nav-type="accordion">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url() . 'marketing' ?>" class="nav-link" target="_blank">
                                <i class="icon-air"></i><span>Go to Marketing Tools</span>
                            </a>
                        </li>
                        <?php if (get_admin_level() == 1): ?>
                            <?php foreach ($menus as $menu): ?>
                                <li
                                    class="nav-item nav-item-submenu <?= $menu['id'] == $id ? 'nav-item-expanded nav-item-open' : ''; ?>">
                                    <a href="<?= ($menu['id'] == 'logout') ? base_url() . 'auth/logout' : '#' ?>" class="nav-link">
                                        <i class="<?= isset($menu['icon']) ? $menu['icon'] : '' ?>"></i><span>
                                            <?= $menu['name'] ?>
                                        </span>
                                    </a>
                                            ...
                                            <?php foreach ($menu['sub_menus'] as $item): ?>
                                                <li <?= isset($sub_id) && $item['id'] == $sub_id ? 'class="nav-item"' : '' ?>>
                                                    <a href="<?= base_url($item['url']) ?>"
                                                        class="nav-link  <?= isset($sub_id) && $item['id'] == $sub_id ? 'active' : '' ?>"><i
                                                            class="    <?= isset($item['icon']) ? $item['icon'] : '' ?>"></i>
                                                        <?= $item['name'] ?>
                                                    </a>
                                                </li>
                                            <?php endforeach; ?>
                            ...
                            <li
                                class="nav-item  nav-item-submenu <?= ($id == 'postbids' || $id == 'bids_sent_log' || $id == 'bids_open_log') ? 'nav-item-expanded nav-item-open' : ''; ?>">
                                <a href="<?= base_url() . 'admin/ads' ?>" class="nav-link">
                                    <i class="icon-color-sampler"></i><span>Postbids</span>
                                </a>
                                <ul class="nav nav-group-sub">
                                    <li class="nav-item">
                                        <a href="<?= base_url() . 'admin/postbids/view' ?>" class="nav-link">
                                            <i class="icon-arrow-right5"></i><span>Postbids data</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url() . 'admin/bidemaillog/view' ?>" class="nav-link">
                                            <i class="icon-arrow-right5"></i><span>Open Logs</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url() . 'admin/bidemailsent/view' ?>" class="nav-link">
                                            <i class="icon-arrow-right5"></i><span>Sent Logs</span>
                                        </a>
                                    </li>
                            ...
                            <li
                                class="nav-item  nav-item-submenu <?= ($id == 'page' || $id == 'config_page' || $id == 'company_type') ? 'nav-item-expanded nav-item-open' : ''; ?>">
                                <a href="<?= base_url() . 'admin/ads' ?>" class="nav-link">
                                    <i class="icon-puzzle"></i><span>Pages & Config</span>
                                </a>
                                <ul class="nav nav-group-sub">
                                    ...
                                    <li class="nav-item">
                                        <a href="<?= base_url() . 'admin/page?page=memberboard' ?>" class="nav-link">
                                            <i class="icon-arrow-right5"></i>Members board</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url() . 'admin/page?page=donate' ?>" class="nav-link">
                                            <i class="icon-arrow-right5"></i>Donation Text Config</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url() . 'admin/company' ?>" class="nav-link">
                                            <i class="icon-arrow-right5"></i>Company Types</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url() . 'admin/webinar_statistic' ?>" class="nav-link">
                                            <i class="icon-arrow-right5"></i>Webinar Statistic</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url() . 'admin/Aicategory' ?>" class="nav-link">
                                            <i class="icon-arrow-right5"></i>AI Category Postbid</a>
                                    </li>

                                    <li class="nav-item">
                                        <a href="<?= base_url() . 'admin/page?page=capsta' ?>" class="nav-link">
                                            <i class="icon-arrow-right5"></i>Cap-Sta Download Config</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url() . 'admin/page?page=referralshare' ?>" class="nav-link">
                                            <i class="icon-arrow-right5"></i>Referral Share Content</a>
                                    </li>

                                </ul>
                            </li>
                            <li class="nav-item">
                                <a href="<?= base_url() . 'admin/referral' ?>" class="nav-link">
                                    <i class="icon-piggy-bank"></i><span>Referral Logs</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?= base_url() . 'admin/sponsorad' ?>" class="nav-link">
                                    <i class="icon-image-compare"></i><span>Sponsors Newsletters</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?= base_url() . 'admin/ads' ?>" class="nav-link">
                            ...
                            <li class="nav-item">
                                <a href="<?= base_url() . 'admin/questionnair/view' ?>" class="nav-link">
                                    <i class="icon-image-compare"></i><span>Questionnaire Answers</span>
                                </a>
                            </li>

                            <li class="nav-item">
                                <a href="<?= base_url() . 'admin/activity' ?>" class="nav-link">
                                    <i class="icon-image-compare"></i><span>Manage Activities</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?= base_url() . 'admin/grant' ?>" class="nav-link">
                                    <i class="icon-image-compare"></i><span>Online grant application</span>
                                </a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="<?= base_url() . 'admin/email/queue' ?>" class="nav-link">
                                    <i class="icon-library2"></i><span>Queue Email Logs</span>
                                </a>
                            </li>
                            <li class="nav-item">
                        ...
                        <?php if (get_admin_level() == 3): ?>
                            ...
                            <li
                                class="nav-item nav-item-submenu <?php echo (in_array($sub_id, array('mailchimp', 'remindemail', 'createemail')) ? 'nav-item-expanded nav-item-open' : '') ?>">
                                <a href="<?= base_url() . 'auth/logout' ?>" class="nav-link">
                                    <i class="icon-feed"></i><span>Email Management</span>
                                </a>
                                <ul id="webinar" class="nav nav-group-sub" style="display: block;">
                                    <li class="nav-item">
                                        <a href="<?php echo site_url('admin/webinar/mailchimp') ?>"
                                            class="<?php echo ($sub_id == 'mailchimp') ? 'nav-link  active' : 'nav-link' ?>"><i
                                                class="icon-arrow-right5"></i>MailChimp</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?php echo site_url('admin/webinar/remindemail') ?>"
                                            class="<?php echo ($sub_id == 'remindemail') ? 'nav-link  active' : 'nav-link' ?>"><i
                                                class="icon-arrow-right5"></i>Remind Email Template</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?php echo site_url('admin/webinar/createemail') ?>"
                                            class="<?php echo ($sub_id == 'createemail') ? 'nav-link  active' : 'nav-link' ?>"><i
                                                class="icon-arrow-right5"></i>Create a webinar email</a>
                                    </li>
                                </ul>
                            </li>
                        <?php endif; ?>
                        <?php if (get_admin_level() == 4): ?>
                            <li class="nav-item">
                                <a href="<?= base_url() . 'admin/dig/list' ?>" class="nav-link">
                                    <i class="icon-newspaper"></i><span>Digital Magazine</span>
                                </a>
                            </li>
                        <?php endif; ?>
                        <li class="nav-item">
