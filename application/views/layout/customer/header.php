...
<head>
    ...
    <link rel="stylesheet" id="elementor-post-10-css" href="<?=base_url().'assets/customer_assets'?>/post-10.css" type="text/css" media="all">
    <link rel="stylesheet" id="elementor-post-243-css" href="<?=base_url().'assets/customer_assets'?>/post-243.css" type="text/css" media="all">
