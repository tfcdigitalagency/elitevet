<?php if(!empty($this->session->userdata('user'))):?>
	<nav role="navigation" class="elementor-nav-menu--main elementor-nav-menu__container elementor-nav-menu--layout-horizontal e--pointer-text e--animation-grow">
		<ul id="menu-1-c85f928" class="elementor-nav-menu" data-smartmenus-id="16067532353891304">
			...
			<?php } ?>
			<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-86"><a href="<?=base_url().'customer/other/benefit'?>" class="elementor-item <?=($id == 'benefit')?'elementor-item-active':'elementor-item-anchor'?>">SPONSORS</a></li>
			<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-86"><a href="<?=base_url().'customer/other/donate'?>" class="elementor-item <?=($id == 'donate')?'elementor-item-active':'elementor-item-anchor'?>">DONATION</a></li>
...
<?php else:?>
	<nav role="navigation" class="elementor-nav-menu--main elementor-nav-menu__container elementor-nav-menu--layout-horizontal e--pointer-text e--animation-grow">
		<ul id="menu-1-c85f928" class="elementor-nav-menu" data-smartmenus-id="16067532353891304">
			<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-10 current_page_item menu-item-82"><a href="<?=base_url().'customer/home'?>" aria-current="page" class="elementor-item <?=($id == 'home')?'elementor-item-active':'elementor-item-anchor'?>">Home</a></li>
			<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-83"><a href="<?=base_url().'customer/other/weare'?>" class="elementor-item <?=($id == 'wedo')?'elementor-item-active':'elementor-item-anchor'?>">We are 501(c)(19)</a></li>
