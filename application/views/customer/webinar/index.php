			...
			<div class="card-body">
				...
				<div style="text-align: center" class="live-iframe">
					<table width="100%">
						<tr>
							<td>
								<iframe id="frameBroast2" src="https://server.ncdeliteveterans.org:4000/video.html" title="Video1" width="100%" height=200" scrolling="no" style="border:0;overflow:hidden"></iframe>
							</td>
						</tr>
					</table>
				</div>
    ...
    <div class="col-sm-12 col-lg-8">
      <div class="card">
        <div class="card-body">
          ...
          <video id="trainingVideoPlayer" src="" autoplay muted autobuffer controls style="width: 100%" class="hide">
            Your browser does not support the video element.
          </video>
			...
			<div class="card">
				<div class="card-body">
					...
					<div style="text-align: right; margin-top: 20px">
						...
						<button type="button" class="btn btn-primary" onclick="playMusic()">Pre Music Count Down</button>
					</div>
				</div>
			</div>
	  </div>
