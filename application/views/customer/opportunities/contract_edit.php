<!-- Page header -->
<link href="<?php echo base_url()?>assets/admin_assets/css/components.min.css" rel="stylesheet" type="text/css">
<script src="<?php echo base_url()?>assets/global_assets/js/plugins/uploaders/fileinput/plugins/purify.min.js"></script>
<script src="<?php echo base_url()?>assets/global_assets/js/plugins/uploaders/fileinput/plugins/sortable.min.js"></script>
<script src="<?php echo base_url()?>assets/global_assets/js/plugins/uploaders/fileinput/fileinput.min.js"></script>
...
<div class="container">
	<div class="page-header">
		<div class="page-header-content header-elements-md-inline">
			<h2 style="width: 100%"> <span class="font-weight-semibold">Update Bid</span>
...
<script>
    ...
    function save_Contract() {
        ...
        if (!check)
            ...
            C.open("POST", base_url + 'customer/opportunities/insert_Contract');
            C.onload = function() {
                ...
                location.href = base_url+'customer/opportunities/mybids';
                return;
            };
