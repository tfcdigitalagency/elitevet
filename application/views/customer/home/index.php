...
Sponsor today!</p>
            ...
            <section class="elementor-element elementor-element-bcf19d5 elementor-section-full_width elementor-section-height-min-height elementor-hidden-tablet elementor-hidden-phone elementor-section-height-default elementor-section-items-middle elementor-section elementor-top-section" data-id="bcf19d5" data-element_type="section" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
                <div class="elementor-container elementor-column-gap-default">
                    <div class="elementor-row">
                        <div class="elementor-element elementor-element-d3f3a8e elementor-column elementor-col-33 elementor-top-column"
                             data-id="d3f3a8e" data-element_type="column">
                            <div class="elementor-column-wrap  elementor-element-populated">
                                <div class="elementor-widget-wrap">
                                    <div class="elementor-element elementor-element-bdd3cb9 elementor-widget elementor-widget-image"
                                         data-id="bdd3cb9" data-element_type="widget" data-widget_type="image.default">
                                        <div class="elementor-widget-container">
                        ...
                        <div class="elementor-element elementor-element-f3e31cd elementor-column elementor-col-33 elementor-top-column"
                             data-id="f3e31cd" data-element_type="column">
                            <div class="elementor-column-wrap  elementor-element-populated">
                                <div class="elementor-widget-wrap">
                                    <div class="elementor-element elementor-element-b928b17 elementor-icon-list--layout-inline elementor-align-center elementor-widget elementor-widget-icon-list"
                                         data-id="b928b17" data-element_type="widget" data-widget_type="icon-list.default">
                                        <div class="elementor-widget-container">
                                            <ul class="elementor-icon-list-items elementor-inline-items">
                                                <li class="elementor-icon-list-item">
                                                    <span class="elementor-icon-list-icon"><i class="fa fa-facebook-f"></i></span>
                                                    <span class="elementor-icon-list-text"></span>
                                                </li>
                                                <li class="elementor-icon-list-item">
                                                    <span class="elementor-icon-list-icon"><i class="fa fa-twitter"></i></span>
                                                    <span class="elementor-icon-list-text"></span>
                                                </li>
                                                <li class="elementor-icon-list-item">
                                                    <span class="elementor-icon-list-icon"><i class="fa fa-linkedin-in"></i></span>
                                                    <span class="elementor-icon-list-text"></span>
                                                </li>
                                                <li class="elementor-icon-list-item">
                                                    <span class="elementor-icon-list-icon"><i class="fa fa-google-plus-g"></i></span>
                                                    <span class="elementor-icon-list-text"></span>
                                                </li>
                                            </ul>
                                        </div>
                        ...
                        <div class="elementor-element elementor-element-9ae7dd3 elementor-column elementor-col-33 elementor-top-column"
                             data-id="9ae7dd3" data-element_type="column">
                            <div class="elementor-column-wrap  elementor-element-populated">
                                <div class="elementor-widget-wrap">
                                    <div class="elementor-element elementor-element-3a680cb elementor-nav-menu__align-right elementor-nav-menu--indicator-classic elementor-nav-menu--dropdown-tablet elementor-nav-menu__text-align-aside elementor-nav-menu--toggle elementor-nav-menu--burger elementor-widget elementor-widget-nav-menu"
                                         data-id="3a680cb" data-element_type="widget" data-settings="{&quot;layout&quot;:&quot;horizontal&quot;,&quot;toggle&quot;:&quot;burger&quot;}"
                                        ...
                                        <?php if(!empty($this->session->userdata('user'))):?>
                                            ...
                                            <nav role="navigation" class="elementor-nav-menu--main elementor-nav-menu__container elementor-nav-menu--layout-horizontal e--pointer-text e--animation-grow">
                                                <ul id="menu-1-c85f928" class="elementor-nav-menu" data-smartmenus-id="16067532353891304">
                                                    ...
                                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-86"><a href="<?=base_url().'customer/other/weare'?>" class="elementor-item <?=($id == 'weare')?'elementor-item-active':'elementor-item-anchor'?>">Who we are</a></li>
                                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-87"><a href="<?=base_url().'customer/contact'?>" class="elementor-item <?=($id == 'contact')?'elementor-item-active':'elementor-item-anchor'?>">CONTACT</a></li>
                                                </ul>
                                            </nav>
                                            <?php endif;?>
            ...
            <section class="elementor-element elementor-element-472f8cd elementor-section-boxed elementor-section-height-default elementor-section-height-default elementor-section elementor-top-section"
                     data-id="472f8cd" data-element_type="section" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
                <div class="elementor-background-overlay"></div>
                <div class="elementor-container elementor-column-gap-default">
                    <div class="elementor-row">
                        <div class="elementor-element elementor-element-6fa5771 elementor-column elementor-col-100 elementor-top-column"
                             data-id="6fa5771" data-element_type="column">
                            <div class="elementor-column-wrap  elementor-element-populated">
                                <div class="elementor-widget-wrap">
                                    <div class="elementor-element elementor-element-5084dd1 elementor-widget elementor-widget-heading"
                                         data-id="5084dd1" data-element_type="widget" data-widget_type="heading.default">
                                        <div class="elementor-widget-container">
                                            <h2 class="elementor-heading-title elementor-size-default">Copyright 2020
                                                <strong>THEELITESDVOBNETWORK</strong>All Right Reserved</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="modal fade" id="registerSponsor" tabindex="-1" role="dialog" aria-labelledby="Sponsor" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form action="<?php echo site_url('customer/home/sponsor')?>" id="sponsor_form" enctype="multipart/form-data" method="post" accept-charset="utf-8"> 
			...
			<div class="modal-footer">
				...
				<input type="submit" value="Upload" class="btn btn-primary" id="btn_register_sponsor" /> 
			</div>
			</form>
		</div>
	</div>
