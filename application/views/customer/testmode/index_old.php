...
<div class="content wrapper">
  ...
  <div class="card">
	...
	<h3>Do you have a question?</h3>
			...
			<form id="frmFQA" method="POST" action="<?php echo site_url("/customer/testmode/addQuestion")?>">
				<div class="row">
				<div class="col-md-10">
...
<div class="card">
	...
	<h3>Your capability Statement Pdf</h3> 
			<form action="<?php echo site_url('customer/testmode/upload')?>" style="display:<?php echo($pdf_link)?'none':''?>" id="pdf_form" enctype="multipart/form-data" method="post" accept-charset="utf-8"> 
				<div class="row">
				<div class="col-md-12">
...
<script>
  ...
  jQuery(document).ready(function() {
	...
	$('#broadcasterNow').click(function(){
		if(!broascatX){
			broascatX = true;
			$('#frameBroast').attr('src', "<?php echo site_url('customer/testmode/host/4000');?>");
			$('#broadcasterNow').removeClass('btn-success').addClass('btn-danger').html('<i class="fa fa-camera"></i> Stop Broadcasting');
		}else{
			$('#frameBroast').attr('src',"<?php echo site_url('customer/testmode/live/4000');?>" );
    ...
    setInterval(function () {
	   //   $.ajax({
			// 	url: base_url+'customer/testmode/getAttended',
			// 	type : 'POST',
			// 	dataType: 'json',
			// 	cache: false,
