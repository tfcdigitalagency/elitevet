        ...
        <div class="card-body">
			<form autocomplete="off"  enctype="multipart/form-data" class="form-validate-jquery" action="<?php echo site_url("postbid/insert/".$hash);?>" method="post">
				...
				<div class="form-group row">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" id="company" name="company" value="<?php echo $data['company']; ?>" placeholder="Please input company name" >
					</div>
				</div>
				<div class="form-group row">
				...
				<div class="form-group row">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" id="name" name="name" value="<?php echo $data['name']; ?>" placeholder="Please enter Name" >
					</div>
				</div>
				<div class="form-group row">
					<label class="col-form-label col-lg-2">Email<span class="text-danger">*</span></label>
					<div class="col-lg-10">
						<input type="email" class="form-control" id="email" name="email" value="<?php echo $data['email']; ?>" placeholder="Please enter Email" >
					</div>
				</div>
				<div class="form-group row">
					<label class="col-form-label col-lg-2">Phone</label>
					<div class="col-lg-10">
						<input type="text" class="form-control" id="phone" name="phone" value="<?php echo $data['phone']; ?>" placeholder="Please enter Phone number" >
					</div>
				</div>
				<div class="form-group row">
					<label class="col-form-label col-lg-2">Sponsor</label>
					<div class="col-lg-10">
						<input type="text" class="form-control" id="sponsor" name="sponsor" value="<?php echo $data['sponsor']; ?>" placeholder="Website Link" >
					</div>
				</div> 
				<div class="form-group row">
					...
					<img width="100" height="100" src ="<?php echo base_url().$data['thumbnail'];?>"/>
					<?php }?>					 
				</div>
				<div class="form-group row">
				...
				<div class="form-group row">
					...
					<div class="col-lg-10">
						<input type="text" autocomplete="off"  class="form-control pickadate" value="<?php echo $data['start_date']; ?>"  id="start_date" name="start_date" placeholder="">
					</div>
				</div>
				<div class="form-group row">
