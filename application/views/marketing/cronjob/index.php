...
<div class="page-header page-header-light">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><span class="font-weight-semibold">Cron-job Management</span></h4>
        </div>
    </div>
</div>
<!-- /page header -->
...
<div class="content">
    ...
    <div class="card">
        <div class="card-body">
            <div class="col-md-12">
                <a href="<?php echo site_url('marketing/cronjob/add');?>" class="btn bg-teal-400"><i class="icon-download"></i> Add New</a>
            </div>
            <div class="col-md-12">
    ...
    jQuery(document).ready(function() {
        ...
        var datatableInit = function () {
            ...
            $article_datatable.dataTable({
                ...
                "ajax": {
                    "type": "POST",
                    "async": true,
                    "url": base_url + "marketing/cronjob/get_data",
                    "data": {},
                    "dataSrc": "data",
                    "dataType": "json",
                    "cache": false,
                ...
                "columnDefs": [
					{
						...
						"createdCell": function (td, cellData, rowData, row, col) {
							...
							$(td).html(cellData!= null?cellData+' emails':'');
						}
					},
					{
						"targets": [3],
						...
						"createdCell": function (td, cellData, rowData, row, col) {
							...
							$(td).html(cellData!= null?cellData+' hours':'');
						}
					},
                    {
                        "targets": [7],
                ...
                "columns": [
                    ...
                    {"title": "Group", "data": "title", "class": "text-left", "width": "55%"},
                    {"title": "Number of Emails", "data": "quantity", "class": "text-center", "width": "10%"},
                    {"title": "Interval", "data": "interval", "class": "text-center", "width": "10%"},
                    {"title": "Status", "data": "status", "class": "text-center", "width": "10%"},
                    {"title": "Last Run At", "data": "last_run", "class": "text-center", "width": "10%"},
        ...
        $(function () {
            ...
            $('#article_datatable tbody').on('click', 'a[title="Edit"]', function () {
                ...
                location.href = base_url+'marketing/cronjob/edit?id='+data.id;
            });
                ...
                swal({
                    ...
                    function (dismiss) {
                        if (dismiss.value) {
                            ...
                            $.ajax({
                                url: base_url+'marketing/cronjob/delete',
                                type : 'POST',
                                data : {
                                    id: data.id
                                },
