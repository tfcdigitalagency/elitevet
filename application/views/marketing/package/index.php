...
<div class="page-header page-header-light">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><span class="font-weight-semibold">Package Management</span></h4>
        </div>
    </div>
</div>
<!-- /page header -->
...
<div class="content">
    ...
    <div class="card">
        <div class="card-body">
            <div class="col-md-12">
                <a href="<?php echo site_url('marketing/package/add');?>" class="btn bg-teal-400"><i class="icon-download"></i> Add New</a>
            </div>
            <div class="col-md-12">
    ...
    jQuery(document).ready(function() {
        ...
        var datatableInit = function () {
            ...
            $article_datatable.dataTable({
                ...
                "ajax": {
                    "type": "POST",
                    "async": true,
                    "url": base_url + "marketing/package/get_data",
                    "data": {},
                    "dataSrc": "data",
                    "dataType": "json",
                    "cache": false,
                ...
                "columns": [
                    ...
                    {"title": "Package Name", "data": "pack_name", "class": "text-left", "width": "55%"},
                    {"title": "Basic Price", "data": "price", "class": "text-center", "width": "10%"},
        ...
        $(function () {
            ...
            $('#article_datatable tbody').on('click', 'a[title="Edit"]', function () {
                ...
                location.href = base_url+'marketing/package/edit?id='+data.id;
            });
                ...
                swal({
                    ...
                    function (dismiss) {
                        if (dismiss.value) {
                            ...
                            $.ajax({
                                url: base_url+'marketing/package/delete',
                                type : 'POST',
                                data : {
                                    id: data.id
                                },
