...
<div class="page-header page-header-light">
	<div class="page-header-content header-elements-md-inline">
		<div class="page-title d-flex">
			<h4><span class="font-weight-semibold">Update Package</span></h4>
	...
	<div class="card">
		<div class="card-body">
			...
			<form class="form-validate-jquery" id="article_form" method="post" action="<?php echo site_url('marketing/package/add')?>">
				<input type="hidden" class="form-control" id="article_id"  name="article_id"  value="<?php echo $data['id']?>">
				<div class="form-group row">
					<label class="col-form-label col-lg-2">Package Name *</label>
					<div class="col-lg-10">
						<input class="form-control" id="pack_name" name="pack_name" placeholder="Please Input Name" value="<?php echo $data['pack_name']?>" required/>
					</div>
				</div>
				<div class="form-group row">
					<label class="col-form-label col-lg-2">Description</label>
					<div class="col-lg-10">
						<textarea class="form-control" rows="3" id="description" name="description" placeholder="Description"><?php echo $data['description']?></textarea>
					</div>
				</div>
				<div class="form-group row">
					<label class="col-form-label col-lg-2">Basic price</label>
					<div class="col-lg-10">
						<input type="number" class="form-control" id="price" name="price" value="<?php echo $data['price']?>" placeholder="Minimum price"/>
					</div>
				</div>
				<div class="form-group row">
					<label class="col-form-label col-lg-2">Package Unit</label>
					<div class="col-lg-10">
						<input type="text" class="form-control" id="unit" name="unit" value="<?php echo $data['unit']?>" placeholder="Unit"/>
					</div>
				</div>
				<div class="form-group row">
					<label class="col-form-label col-lg-2">Popular</label>
					<div class="col-lg-10">
						<label><input type="radio" value="1" id="popular1" name="popular" <?php if($data['popular']) echo 'checked'?>/> Yes</label>
						<label><input type="radio" value="0" id="popular2" name="popular" <?php if(!$data['popular']) echo 'checked'?>/> No</label>
					</div>
				</div>
				<div class="form-group row">
				...
				<div class="form-group row">
					...
					<div id="packOptionWrap" class="col-lg-10">
						...
						<div class="packOption row">
							<div class="col-12"><label class="font-weight-bold">Option <span class="row_no"><?php echo ($k+1)?></span></label></div>
							<div class="col-3">
								<input title="Option name" type="text" class="form-control row_option" id="pack_name" name="detail[options][]" value="<?php echo $item['options']?>" placeholder="Option name"/>
							</div>
							<div class="col-2" style="position:relative">
								<input title="Pricce" type="number" class="form-control row_price" id="pack_price" name="detail[price][]" value="<?php echo $item['price']?>" placeholder="Price"/><span style="position: absolute; top: 6px; right: 18px;">$</span>
							</div>
							<div class="col-2">
								<input title="Note" type="text" class="form-control row_note" id="pack_note" name="detail[note][]" value="<?php echo $item['note']?>" placeholder="Note"/>
							</div>
							<div class="col-1 row_optional_wrap">
								<label style="margin-top: 8px"><input type="checkbox" class="row_optional" <?php if($item['require']) echo 'checked'?>/> Required</label>
								<input type="hidden" class="form-control row_required_value"  name="detail[require][]" value="<?php echo intval($item['require'])?>" />
							</div>
							<div class="col-2">
	...
	<template id="packTemplate">
		<div class="packOption row">
			...
			<div class="col-1 row_optional_wrap">
				...
				<input type="hidden" class="form-control row_required_value"  name="detail[require][]" value="0" />
			</div>
			<div class="col-2">
				<a class="add_item cursor-pointer font-size-lg"><i class="fa fa-plus-circle"></i></a>
				<a class="remove_item cursor-pointer font-size-lg"><i class="fa fa-trash-o"></i></a>
