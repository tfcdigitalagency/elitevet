...
<div class="page-header page-header-light">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Total Events Registered by User "<?php echo $user[0]['name']; ?>"</span></h4>
    ...
    jQuery(document).ready(function() {
        ...
        var datatableInit = function () {
            ...
            $event_datatable.dataTable({
                ...
                "searching": true,
                "sServerMethod": "POST",
                "sAjaxSource":base_url + "admin/user/get_reg_History",
                ...
                "columns": [
                    ...
                    {"title": "Registered Date", "data": "registered_at", "class": "text-center", "width": "5%"},
