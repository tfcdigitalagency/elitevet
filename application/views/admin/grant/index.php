...
<div class="page-header page-header-light">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><span class="font-weight-semibold">Online Grant Application</span></h4>
        </div>
    </div>
</div>
<!-- /page header -->
...
<div class="content">
    ...
    <div class="card">
        <div class="card-body">
            <div class="col-md-12">
                <a href="<?php echo site_url('admin/grant/import');?>" class="btn bg-teal-400"><i class="icon-download"></i> Import</a>
            </div>
            <div class="col-md-12">
        ...
        var datatableInit = function () {
            ...
            $article_datatable.dataTable({
                ...
                "ajax": {
                    "type": "POST",
                    "async": true,
                    "url": base_url + "admin/grant/get_data",
                    "data": {},
                    "dataSrc": "data",
                    "dataType": "json",
                    "cache": false,
                ...
                "columns": [
                    ...
                    {"title": "Company", "data": "company", "class": "text-left", "width": "10%"},
                    {"title": "Form", "data": "form", "class": "text-left", "width": "10%"},
                ...
                swal({
                    ...
                    function (dismiss) {
                        if (dismiss.value) {
                            ...
                            $.ajax({
                                url: base_url+'admin/grant/delete',
                                type : 'POST',
                                data : {
                                    id: data.id
                                },
