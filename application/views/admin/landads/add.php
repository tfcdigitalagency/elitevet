...
<div class="page-header page-header-light">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><span class="font-weight-semibold">Add Banner</span></h4>
...
<div class="content">
    ...
    <div class="card">
        <div class="card-body">
        	...
        	<form class="form-validate-jquery" id="article_form" method="post" action="<?php echo site_url('admin/landads/add')?>">
				...
				<div class="form-group row">
					...
					<div class="col-lg-10">
						<input class="form-control" id="link_active" name="link_active" placeholder="Please Input URL" required/>
					</div>
				</div>
				<div class="form-group row">
					<label class="col-form-label col-lg-2">Link Normal</label>
					<div class="col-lg-10">
						<input class="form-control" id="link_normal" name="link_normal" placeholder="Please Input URL" required/>
					</div>
				</div>				
...
<script>
	...
	function save_article() {
			...
			C.onload = function() {
				//location.href = base_url+'admin/landads';
				return;
			};
			C.send(A);
