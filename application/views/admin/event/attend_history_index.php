...
<div class="page-header page-header-light">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><i class="icon-arrow-left52 mr-2" onclick="Goback()"></i> <span class="font-weight-semibold">Attended History  Of Event "<?php echo $event[0]['name']; ?>"</span></h4>
    ...
    jQuery(document).ready(function() {
        ...
        var datatableInit = function () {
            ...
            $event_datatable.dataTable({
                ...
                "info": true,
                "searching": true,
                "sAjaxSource":base_url + "admin/event/get_attend_History",
                ...
                "columns": [
                    ...
                    {"title": "attended_at", "data": "attended_at", "class": "text-center", "width": "5%"},
