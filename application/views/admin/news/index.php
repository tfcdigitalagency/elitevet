...
<div class="page-header page-header-light">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><span class="font-weight-semibold">Manage Articles</span></h4>
        </div>
    </div>
</div>
<!-- /page header -->
...
<div class="content">
    ...
    <div class="card">
        <div class="card-body">
            <div class="col-md-12">
                <a href="<?php echo site_url('admin/news/add');?>" class="btn bg-teal-400"><i class="icon-download"></i> Add New</a>
            </div>
            <div class="col-md-12">
    ...
    jQuery(document).ready(function() {
        ...
        var datatableInit = function () {
            ...
            $article_datatable.dataTable({
                ...
                "ajax": {
                    "type": "POST",
                    "async": true,
                    "url": base_url + "admin/news/get_data",
                    "data": {},
                    "dataSrc": "data",
                    "dataType": "json",
                    "cache": false,
                ...
                "columns": [
                    ...
                    {"title": "Sent", "data": "sent", "class": "text-center", "width": "10%"},
                    {"title": "Opened", "data": "opened", "class": "text-center", "width": "10%"},
        ...
        $(function () {
            ...
            $('#article_datatable tbody').on('click', 'a[title="Edit"]', function () {
                ...
                location.href = base_url+'admin/news/edit?id='+data.id;
            });
