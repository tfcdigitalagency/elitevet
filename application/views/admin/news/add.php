...
<div class="page-header page-header-light">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><span class="font-weight-semibold">Add Article</span></h4>
...
<div class="content">
    ...
    <div class="card">
        <div class="card-body">
        	...
        	<form class="form-validate-jquery" id="article_form" method="post" action="<?php echo site_url('admin/news/add')?>">
				...
				<div class="form-group row">
					...
					<div class="col-lg-10">
						<textarea rows="5" cols="3" class="form-control" id="short" name="short" required></textarea>
					</div>
				</div>
				<div class="form-group row">
					<label class="col-form-label col-lg-2">Detail *</label>
					<div class="col-lg-10">
						<textarea rows="5" cols="3" class="form-control" id="content" name="content"></textarea>
					</div>
				</div>
