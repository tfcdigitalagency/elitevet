		...
		<div class="modal-content">
			...
			<div class="modal-body">
				 ...
				 <input type="hidden" name="code" value="TOKEN1"/>
					...
					<!--div style="text-align:right"><a target="_blank" href="<?php echo site_url('/admin/postbids/guide');?>">Guide how to get Token?</a></div-->
				 </form>
			</div>
		</div>
	</div>
...
<script>
    ...
    jQuery(document).ready(function() {
        ...
        var datatableInit = function () {
            ...
            $contract_datatable.dataTable({
                ...
                "ajax": {
                    "type": "POST",
                    "async": true,
                    "url": base_url + "admin/postbids/get_Contract",
                    "data": {},
                    "dataSrc": "data",
                    "dataType": "json",
                    "cache": false,
        ...
        $(function () {
            ...
            $('#contract_datatable tbody').on('click', 'a[title="Edit"]', function () {
                ...
                location.href = base_url+'admin/postbids/contract_edit?id='+data.id;
            });
                ...
                swal({
                    ...
                    function (dismiss) {
                        if (dismiss.value) {
                            ...
                            $.ajax({
                                url: base_url+'admin/postbids/del_Contract',
                                type : 'POST',
                                data : {
                                    id: data.id
                                },
    ...
    function add_contract(){
        location.href = base_url+'admin/postbids/add';
    }
	...
	function create_link(){
		if(creating==0){
			creating = 1;
			 $.ajax({
				url: base_url+'admin/postbids/create_link',
				type : 'POST',
				data : {},
				cache: false,
				success: function(result) {
	...
	function download(){
		document.location = '<?php echo site_url('/admin/postbids/download_bids')?>';
	}
	...
	$('#frm_token').submit(function(e){
		e.preventDefault();
		$.ajax({
				url: base_url+'/admin/postbids/update_token',
				type : 'POST',
