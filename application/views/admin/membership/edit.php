        ...
        <div class="card-body">
        	<form class="form-validate-jquery" method="post" target="_other">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <input type="text" class="form-control" id="name" placeholder="Please Input Membership Name" value="<?php echo $data[0]['name']; ?>" required>
                    </div>
                </div> 
                <div class="form-group row">
                    <label class="col-form-label col-lg-2">Cost</label>
                    <div class="col-lg-10">
                        <input type="text" class="form-control" id="cost" placeholder="Please Input Membership Cost" value="<?php echo $data[0]['cost']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-form-label col-lg-2">Details</label>
                    <div class="col-lg-10">
                        <input type="text" class="form-control" id="details" placeholder="Please Input Membership Details" value="<?php echo $data[0]['details']; ?>">
                    </div>
                </div>
